...
def plot_environment_layout(bs_pos, interferers=None, grid_bounds=(5, 101, 5, 101), scenario_label="3GPP 38.901 UMi NLOS", save_path=None):
    ...
    - Interfering Base Stations (with SW tower pushed outward to -60m, -60m)
    ...
    # Plot Interfering Base Stations (Pushed SW to [-60, -60, 10])
    if interferers is None:
        interferers = [[-60, -60, 10], [200, -60, 10], [200, 200, 10], [-60, 200, 10]]
        
    int_colors = ['darkorange', 'purple', 'forestgreen', 'chocolate']
    labels = ['Int-1 (South-West)', 'Int-2 (South-East)', 'Int-3 (North-East)', 'Int-4 (North-West)']
    ...
    info_txt = (
        ...
        f"SW Interferer Position: [-60m, -60m] (Pushed SW)\n"
    ...
    ax.set_title('5G NR Environment Layout: Pushed SW Interferer & 25x25 Grid Footprint', fontsize=13, fontweight='bold')
...
def analyze_distance_and_interference_errors(preds, targs, bs_pos, interferers=None, report_dir=None):
    ...
    if report_dir:
        ...
        md_lines = [
            ...
            "- **South-West Interferer (Pushed SW):** `[-60, -60, 10] meters`",
            "- **Other Interferers:** `[200, -60, 10], [200, 200, 10], [-60, 200, 10]`",
            "- **Grid Area:** 25x25 Grid Footprint `[5m, 101m] x [5m, 101m]`",
            "",
            "## 2. Distance to Main Base Station Breakdown",
        ...
        md_lines.extend([
            "",
            "## 3. Distance to Nearest Interfering Base Station Breakdown",
...
if __name__ == '__main__':
    ...
    out_img = Path("C:/Users/gilad/.gemini/antigravity-ide/brain/b90924c7-9fdd-41b2-b6e8-198355c5aa66/env_layout_pushed_sw.png")
